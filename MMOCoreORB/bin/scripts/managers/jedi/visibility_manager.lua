maxVisibility = 24000      -- Maximum visibility
termThreshold = 250      -- Visibility Jedi will show on terminals
falloffThreshold = 25    -- Visibility jedi will disappear off terminals
totalDecayTimeInDays = 63 -- Total time before visibility decays from cap
