world_boss_jabba_henchman = Creature:new {
	...
	baseHAMmax = 15000,
	armor = 1,
	resists = {35,35,35,35,35,35,35,35,15},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(world_boss_jabba_henchman, "world_boss_jabba_henchman")
