...
includeFile("custom/jedi/vessa_kael.lua")
includeFile("custom/jedi/rarruk_graal.lua")
includeFile("custom/jedi/jalen_vort.lua")
includeFile("custom/jedi/sskarr_vrenn.lua")

includeFile("custom/jedi/cozmic.lua")
includeFile("custom/jedi/wookiee_warrior.lua")
includeFile("custom/jedi/wookiee_hunter.lua")
includeFile("custom/jedi/karrhukk_rroshkaar.lua")
includeFile("custom/jedi/sap.lua")
includeFile("custom/jedi/trandoshan_warrior.lua")
includeFile("custom/jedi/trandoshan_hunter.lua")
includeFile("custom/jedi/ssethrix_vosskrall.lua")

includeFile("custom/jedi/lazarus.lua")
includeFile("custom/jedi/lazarus_monster.lua")

includeFile("custom/jedi/hermit_trial.lua")

includeFile("custom/jedi/herald_of_the_whills.lua")
...
includeFile("custom/shae_torrvek.lua")
...
includeFile("custom/treasure_stan.lua")
includeFile("custom/kreezo.lua")
...
includeFile("custom/mobs/world_boss/world_boss_jabba_overlord.lua")
includeFile("custom/mobs/world_boss/world_boss_jabba_henchman.lua")
includeFile("custom/mobs/world_boss/world_boss_death_watch.lua")
includeFile("custom/mobs/world_boss/world_boss_death_watch_drone.lua")
...
includeFile("custom/mobs/meatlump_king_clod.lua")
includeFile("custom/mobs/meatlump_king_cretin.lua")
includeFile("custom/mobs/meatlump_king_fool.lua")
includeFile("custom/mobs/meatlump_king_loon.lua")
