bh_singing_mountain_clan_councilwoman = Creature:new {
	...
	baseHAMmax = 392000,
	armor = 3,
	resists = {200,200,200,200,200,200,200,200,-1},
	meatType = "",
	meatAmount = 0,
	hideType = "",
	hideAmount = 0,
...
CreatureTemplates:addCreatureTemplate(bh_singing_mountain_clan_councilwoman, "bh_singing_mountain_clan_councilwoman")
