reward_third_convo_template = ConvoTemplate:new {
  initialScreen = "greeting",
  templateType = "Lua",
  luaClassHandler = "rewardThirdConvoHandler",
  screens = {}
}
...
reward_third_convo_template:addScreen(greeting)
...
addConversationTemplate("reward_third_convo_template", reward_third_convo_template);