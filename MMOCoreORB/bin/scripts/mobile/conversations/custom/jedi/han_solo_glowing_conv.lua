...
accept = ConvoScreen:new {
  id = "accept",
  customDialogText = "I parked her just outside of town. Watch for Tuskens—those sand rats are relentless—and keep an eye on Jawas; they've got sticky fingers. Don't let them strip the ship for parts.",
  stopConversation = "false",
  options = {
...
accept_quest_active = ConvoScreen:new {
	...
	customDialogText = "Hey! Have you checked on the ship yet, or just sightseeing in the desert?",
	stopConversation = "true",
	options = {}
}
