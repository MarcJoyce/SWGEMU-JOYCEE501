...
function NymConvoHandler:runNymScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "go_lab") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Imperial Research Facility", "Imperial Research Facility", ThemeParkNym.waypointMap.researchfacility.x, 0, ThemeParkNym.waypointMap.researchfacility.y, WAYPOINT_YELLOW, true, true, 0)
	...
	elseif (screenID == "go_to_officer") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Nym's Informant", "Nym's Informant", ThemeParkNym.waypointMap.gambler.x, 0, ThemeParkNym.waypointMap.gambler.y, WAYPOINT_YELLOW, true, true, 0)
...
function NymConvoHandler:runJinkinsScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	if (screenID == "heres_droid_memory") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Sulfur Lake Pirate Hideout", "", ThemeParkNym.waypointMap.piratecave.x, 0, ThemeParkNym.waypointMap.piratecave.y, WAYPOINT_YELLOW, true, true, 0)
	...
	elseif (screenID == "heres_the_guy") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Hermit", "", ThemeParkNym.waypointMap.choster.x, 0, ThemeParkNym.waypointMap.choster.y, WAYPOINT_YELLOW, true, true, 0)
...
function NymConvoHandler:runKoleScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	elseif (screenID == "here_is_gas") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Imperial Gas Mine", "", ThemeParkNym.waypointMap.gasmine.x, 0, ThemeParkNym.waypointMap.gasmine.y, WAYPOINT_YELLOW, true, true, 0)
	...
	elseif (screenID == "here_is_imperial") then
		...
		local waypointID = PlayerObject(pGhost):addWaypoint("lok", "Sergeant Moore", "", ThemeParkNym.waypointMap.imperialbribe.x, 0, ThemeParkNym.waypointMap.imperialbribe.y, WAYPOINT_YELLOW, true, true, 0)
