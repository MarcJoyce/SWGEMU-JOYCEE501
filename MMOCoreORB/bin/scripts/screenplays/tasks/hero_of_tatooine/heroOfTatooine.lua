...
function HeroOfTatooineScreenPlay:giveAltruismWaypoint(pPlayer)
	...
	local waypointID = PlayerObject(pGhost):addWaypoint("tatooine", "Kidnapped Family", "", 6555, 0, -1311, WAYPOINT_YELLOW, true, true, 0, 1)
...
function HeroOfTatooineScreenPlay:giveHonorWaypoint(pPlayer)
	...
	local waypointID = PlayerObject(pGhost):addWaypoint("tatooine", "Ranch House", "", 4993, 0, -4682, WAYPOINT_YELLOW, true, true, 0, 1)
