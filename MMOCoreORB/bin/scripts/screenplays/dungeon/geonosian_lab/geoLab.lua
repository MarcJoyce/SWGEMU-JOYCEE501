...
function GeonosianLab:spawnMobiles()
	...
	-- hall1 (1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, 26.6,10.3,-13.3,-8,1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, 32.3,9.5,-8.1,-105,1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, 34.7,10.3,-14.4,-70,1627782)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, 37.4,9.8,-8.2,-109,1627782)

	-- hall2 (1627783)

	-- transition1 (1627784)
	spawnMobile("yavin4", "alert_droideka", 150, -18,-18,-36,0,1627784)

	-- assistant_armory (1627785)
	spawnMobile("yavin4", "biogenic_securitytech", 1, -48, -18, -31, 180, 1627785)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -55.9,-18,-33.9,95,1627785)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -55.6,-18,-43.2,72,1627785)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -38.7,-18,-47.5,-75,1627785)

	-- transition2 (1627786)
	spawnMobile("yavin4", "alert_droideka", 150, -62,-18,-59.5,-180,1627786)

	-- intersection1 (1627787)

	-- caveroom1 (1627788)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -66.7,-19,-41.2,-77,1627788)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -70.5,-18.9,-34.5,-161,1627788)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -83.9,-18.5,-42.3,85,1627788)

	-- transition3 (1627789)
	spawnMobile("yavin4", "alert_droideka", 150, -90.5,-18,-76,0,1627789)

	-- lab1 (1627790)
	spawnMobile("yavin4", "biogenic_engineertech", 1,-106.5,-18,-33,50,1627790)
	spawnMobile("yavin4", "geonosian_scientist", 150, -118.4,-20,-39.2,175,1627790)

	-- hall3 (1627791)
	spawnMobile("yavin4", "alert_droideka", 150, -53.5,-18.2,-81.7,-90,1627791)

	-- intersection2 (1627792)

	-- largecavehall1 (1627793)
	spawnMobile("yavin4", "cavern_spider", 150, -88.3,-21.8,-110.3,210,1627793)
	spawnMobile("yavin4", "cavern_spider", 150, -98,-21.9,-114.7,50,1627793)
	spawnMobile("yavin4", "cavern_spider", 150, -107.3,-22.2,-96.6,180,1627793)
	spawnMobile("yavin4", "cavern_spider", 150, -108,-21.8,-126,0,1627793)
	spawnMobile("yavin4", "cavern_spider", 150, -123,-22,-109.5,80,1627793)
	spawnMobile("yavin4", "cavern_spider", 150, -134.7,-20.9,-112.2,77,1627793)

	-- largecavehall2 (1627794)
	spawnMobile("yavin4", "biogenic_construction", 1, -134.5, -21.7, -74.8, 90, 1627794)
	spawnMobile("yavin4", "enhanced_gaping_spider",300,-130,-22.1,-85,-180,1627794) -- Randomized respawn

	-- hall4 (1627795)

	-- intersection3 (1627796)
	spawnMobile("yavin4", "alert_droideka", 150, -3.8,-30.2,-92,-180,1627796)
	spawnMobile("yavin4", "cavern_spider", 150, -16.8,-30.2,-115.1,22,1627796)

	-- hall5 (1627797)

	-- caveroom2 (1627798)
	spawnMobile("yavin4", "biogenic_scientist_human", 1, 23.8, -32, -83.2, 130, 1627798)
	spawnMobile("yavin4", "enhanced_kliknik", 150, 26,-31.5,-78,170,1627798)
	spawnMobile("yavin4", "enhanced_kliknik", 150, 36.5,-29.9,-82.7,-120,1627798)
	spawnMobile("yavin4", "enhanced_kliknik", 150, 29.5,-30.1,-88,-45,1627798)

	-- hall6 (1627799)

	-- intersection4 (1627800)
	spawnMobile("yavin4", "cavern_spider", 150, -48,-21.8,-158,0,1627800)
	spawnMobile("yavin4", "cavern_spider", 150, -48,-21.8,-143,0,1627800)

	-- transition4 (1627801)
	spawnMobile("yavin4", "alert_droideka", 150, -34.2,-22,-128,-180,1627801)

	-- bedroom (1627802)
	spawnMobile("yavin4", "imperial_observer", 150, -23,-22,-116,-90,1627802)
	spawnMobile("yavin4", "imperial_observer", 150, -16.4,-22,-114.5,-150,1627802)

	-- cavecage1 (1627803)
	spawnMobile("yavin4", "biogenic_assistant", 1, -36, -21.9, -162.8, 0, 1627803)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -36,-22,-151.4,180,1627803)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -26.8,-22.9,-158,-90,1627803)
	spawnMobile("yavin4", "crazed_geonosian_guard", 150, -19.4,-22.6,-151.7,-135,1627803)

	-- transition5 (1627804)
	spawnMobile("yavin4", "alert_droideka", 150, -63.9,-22.0,-143.0,-3,1627804)

	-- office (1627805)
	spawnMobile("yavin4", "mercenary_sentry", 150, -74.9,-22,-153.7,-119,1627805)
	spawnMobile("yavin4", "mercenary_sentry", 150, -74.3,-22,-162.3,-40,1627805)
	spawnMobile("yavin4", "mercenary_sentry", 150, -82.3,-22,-161.7,74,1627805)
	spawnMobile("yavin4", "mercenary_sentry", 150, -82.2,-22,-155.1,106,1627805)

	-- hall7 (1627806)

	-- hall8 (1627807)
	spawnMobile("yavin4", "enhanced_kwi", 150, -104.2,-28.7,-193.4,0,1627807)

	-- transition6 (1627808)
	spawnMobile("yavin4", "alert_droideka", 150, -108,-34,-214,89,1627808)
	...
	-- transition7 (1627811)
	spawnMobile("yavin4", "alert_droideka", 150, -61.5,-34,-252,-90,1627811)

	-- operatingroom1 (1627812)
	spawnMobile("yavin4", "biogenic_scientist_generic_01", 1, -72.0, -34, -272.9, 0, 1627812)
	spawnMobile("yavin4", "geonosian_scientist", 150, -60.0,-34.0,-273.7,0,1627812)
	spawnMobile("yavin4", "enhanced_kliknik", 150, -64.9,-34,-266.5,-143,1627812)
	spawnMobile("yavin4", "enhanced_kwi", 150, -66.5,-34,-283.1,35,1627812)
	...
	spawnMobile("yavin4", "enhanced_kwi", 150, -143.2,-34,-180.8,-139,1627815)
	spawnMobile("yavin4", "enhanced_kliknik", 150, -129.0,-34,-192.6,-32,1627815)
	spawnMobile("yavin4", "geonosian_scientist", 150, -124.3,-34.0,-199.5,-60,1627815)
	spawnMobile("yavin4", "enhanced_kliknik", 150, -139.8,-34,-194.3,57,1627815)

	-- transition9 (1627816)
	spawnMobile("yavin4", "alert_droideka", 150, -129.8,-34.0,-267.9,87,1627816)

	-- cavecages2 (1627817)
	spawnMobile("yavin4", "cavern_spider", 150, -128.2,-34.4,-322.4,-30,1627817)
	spawnMobile("yavin4", "cavern_spider", 150, -143.5,-33.5,-321.7,134,1627817)
	spawnMobile("yavin4", "cavern_spider", 150, -131.1,-33.9,-339.0,145,1627817)
	spawnMobile("yavin4", "cavern_spider", 150, -135.5,-33.8,-342.8,-1,1627817)

	-- cavecages3 (1627818)
	spawnMobile("yavin4", "cavern_spider", 150, -118.9,-34.0,-349.2,-98,1627818)
	spawnMobile("yavin4", "cavern_spider", 150, -134.5,-34.0,-373.2,-2,1627818)
	spawnMobile("yavin4", "enhanced_kliknik", 150, -129.4,-33.6,-384.1,-2,1627818)

	-- cavecages4 (1627819)
	spawnMobile("yavin4", "enhanced_kliknik", 150, -87,-34.1,-386.5,210,1627819)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -86.5,-33.9,-372.8,-91,1627819)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -88.0,-34.6,-365.9,-102,1627819)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -71.5,-34,-348.1,-95,1627819)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -72.6,-33.8,-376.0,-168,1627819)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -72.7,-34.2,-382.5,-179,1627819)

	-- largecavehall3 (1627820)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -69.0,-34.0,-407.2,-7,1627820)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -46.8,-34.0,-407.5,92,1627820)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, -28.5,-34.2,-408.4,-27,1627820)

	-- transition10 (1627821)
	spawnMobile("yavin4", "alert_droideka", 150, -11.9,-34.0,-412.5,179,1627821)

	-- grandcageroom (1627822)
	spawnMobile("yavin4", "biogenic_scientist_geonosian", 1, 7.4, -22, -333, 180, 1627822)
	spawnMobile("yavin4", "cavern_spider", 150, 4.1,-34.0,-402.4,171,1627822)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, 16.5,-34.0,-368.3,161,1627822)
	spawnMobile("yavin4", "enhanced_kliknik", 150, 24.0,-34.0,-397.1,117,1627822)
	spawnMobile("yavin4", "enhanced_force_kliknik", 150, 22.9,-34.0,-370.1,11,1627822)
	spawnMobile("yavin4", "cavern_spider", 150, 24.8,-24.0,-333.8,87,1627822)
	spawnMobile("yavin4", "cavern_spider", 150, 13.3,-24.0,-341.6,89,1627822)
	spawnMobile("yavin4", "cavern_spider", 150, 13.4,-22.0,-337.3,-179,1627822)

	-- largeendcave (1627823)
	spawnMobile("yavin4", "acklay",600,101.1,-34.3,-321.6,-136,1627823) --Randomized respawn
	spawnMobile("yavin4", "enhanced_kwi", 150, 48.0,-34.0,-334.4,0,1627823)
	spawnMobile("yavin4", "cavern_spider", 150, 91.2,-33.9,-347.9,5,1627823)
	spawnMobile("yavin4", "enhanced_kliknik", 150, 98.0,-34.1,-334.4,-53,1627823)
	spawnMobile("yavin4", "enhanced_kliknik", 150, 120.2,-33.9,-330.6,-33,1627823)
	spawnMobile("yavin4", "cavern_spider", 150, 85.0,-33.8,-309.1,143,1627823)
	spawnMobile("yavin4", "cavern_spider", 150, 74.7,-34.1,-329.0,-90,1627823)

	-- spiralhallway (1627824)
	spawnMobile("yavin4", "enhanced_kwi", 150, 9.5,-16.0,-27.9,89,1627824)
	spawnMobile("yavin4", "enhanced_kwi", 150, 10.8,-6.3,-7.8,-93,1627824)
