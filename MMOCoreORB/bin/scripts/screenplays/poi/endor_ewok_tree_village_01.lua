...
EndorEwokTreeVillage01ScreenPlay = ScreenPlay:new {
	...
	mobiles = {
		--Tree # 1
		--On the ground
		{"wookiee_hunter",180,66,9,50,40,0},--FurthestEwokHutFromStairs(4/4)
		{"wookiee_hunter",180,71.5,9,46.6,54,0},--EwokHutFromStairs(3/4)
		{"wookiee_hunter",180,77,9,37,45,0},--GuardNearTikiTourch(2/4)
		{"wookiee_hunter",180,78,9,40,135,0},--GuardNearTikiTourch(1/4)
		{"wookiee_hunter",180,61,9,32,-135,0},--GuardingStairs
		--First Floor
		...
		--Tree # 2
		--On the ground
		{"wookiee_hunter",180,86.6,9,63.1,170,0},--FurthestEwokHutFromStairs(1/1)
		{"wookiee_hunter",180,75.7,9,63.5,175,0},--GuardNearTikiTourch(1/4)
		...
		--Tree # 3
		--On the ground
		{"wookiee_hunter",180,72.8,9,21.7,27,0},--GuardNearTikiTourch(3/3)
		{"wookiee_hunter",180,75.6,9,24.5,-117,0},--GuardNearTikiTourch(2/3)
		{"wookiee_hunter",180,93.4,9,19.1,-16,0},--GuardNearTikiTourch(1/3)
		...
		--Tree # 4
		--On the ground
		{"wookiee_hunter",180,96.2,9,61.9,157,0},--GuardNearFire(2/2)
		{"wookiee_hunter",180,98.8,9,59.3,-94,0},--GuardNearFire(1/2)
		...
		--Tree # 5
		--On the ground
		{"wookiee_hunter",180,95.5,9,36.7,-118,0},--FurthestEwokHutFromStairs(1/1)
		{"wookiee_hunter",180,94.6,9,48.3,-9,0},--GuardNearFire(2/2)
		{"wookiee_hunter",180,97.3,9,51,-78,0},--GuardNearFire(1/2)
