infused_force_crystal_banes_heart = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Bane's Heart",
...
addLootItemTemplate("infused_force_crystal_banes_heart", infused_force_crystal_banes_heart)