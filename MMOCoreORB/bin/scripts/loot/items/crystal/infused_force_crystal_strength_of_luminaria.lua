infused_force_crystal_strength_of_luminaria = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Strength of Luminaria",
...
addLootItemTemplate("infused_force_crystal_strength_of_luminaria", infused_force_crystal_strength_of_luminaria)
