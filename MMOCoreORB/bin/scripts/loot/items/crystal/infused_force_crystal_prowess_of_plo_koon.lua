infused_force_crystal_prowess_of_plo_koon = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Prowess of Plo Koon",
...
addLootItemTemplate("infused_force_crystal_prowess_of_plo_koon", infused_force_crystal_prowess_of_plo_koon)
