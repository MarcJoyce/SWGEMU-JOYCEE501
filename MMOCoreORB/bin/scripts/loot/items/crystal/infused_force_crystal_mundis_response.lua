infused_force_crystal_mundis_response = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Mundi's Response",
...
addLootItemTemplate("infused_force_crystal_mundis_response", infused_force_crystal_mundis_response)
