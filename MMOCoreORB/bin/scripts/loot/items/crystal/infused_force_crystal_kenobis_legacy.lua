infused_force_crystal_kenobis_legacy = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Kenobi's Legacy",
...
addLootItemTemplate("infused_force_crystal_kenobis_legacy", infused_force_crystal_kenobis_legacy)
