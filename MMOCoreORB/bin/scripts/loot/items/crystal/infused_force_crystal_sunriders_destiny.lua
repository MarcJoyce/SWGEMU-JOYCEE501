infused_force_crystal_sunriders_destiny = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Sunrider's Destiny",
...
addLootItemTemplate("infused_force_crystal_sunriders_destiny", infused_force_crystal_sunriders_destiny)
