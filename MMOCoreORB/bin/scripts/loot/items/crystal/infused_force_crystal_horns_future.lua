infused_force_crystal_horns_future = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Horn's Future",
...
addLootItemTemplate("infused_force_crystal_horns_future", infused_force_crystal_horns_future)
