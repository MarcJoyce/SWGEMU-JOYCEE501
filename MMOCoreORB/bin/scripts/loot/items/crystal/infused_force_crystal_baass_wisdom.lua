infused_force_crystal_baass_wisdom = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Baas's Wisdom",
...
addLootItemTemplate("infused_force_crystal_baass_wisdom", infused_force_crystal_baass_wisdom)