infused_force_crystal_quintessence_of_the_force = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Quintessence of the Force",
...
addLootItemTemplate("infused_force_crystal_quintessence_of_the_force", infused_force_crystal_quintessence_of_the_force)
