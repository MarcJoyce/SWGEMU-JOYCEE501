infused_force_crystal_qui_gons_devotion = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Qui-Gon's Devotion",
...
addLootItemTemplate("infused_force_crystal_qui_gons_devotion", infused_force_crystal_qui_gons_devotion)
