infused_force_crystal_kits_ferocity = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Kit's Ferocity",
...
addLootItemTemplate("infused_force_crystal_kits_ferocity", infused_force_crystal_kits_ferocity)
