infused_force_crystal_kuns_blood = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Kun's Blood",
...
addLootItemTemplate("infused_force_crystal_kuns_blood", infused_force_crystal_kuns_blood)
