infused_force_crystal_mauls_vengence = {
	minimumLevel = 0,
	maximumLevel = -1,
	customObjectName = "(Infused) Maul's Vengence",
...
addLootItemTemplate("infused_force_crystal_mauls_vengence", infused_force_crystal_mauls_vengence)
